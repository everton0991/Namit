...
var paths = {
  scripts_controllers: ['dev/assets/js/controllers/**/*.js'],
  scripts_vendors: ['dev/assets/js/vendors/**/*.js'],
  scripts_views: ['dev/assets/js/views/**/*.js'],
